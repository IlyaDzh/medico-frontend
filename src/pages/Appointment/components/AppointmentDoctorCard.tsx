...
import doctorAvatar from "../doctor.png";
...
export const AppointmentDoctorCard: React.FC<IAppointmentDoctorCard> = ({
    displayDetails
}) => {
        ...
        <div className={classes.doctorCard}>
            ...
            <div className={classes.doctorCardHeader}>
                <div className={classes.doctorAvatar}>
                    <img src={doctorAvatar} alt="Фото Алла" />
                </div>
                <div>
                    <Typography
                    ...
                    <Link className={classes.doctorReviews} to="/doctor/1">
                        5 отзывов
                    </Link>
                </div>
            </div>
            {displayDetails && (
                <React.Fragment>
                    ...
                    <div className={classes.doctorCardFooter}>
                        ...
                        <Typography variant="body1">Болит голова</Typography>
                    </div>
                </React.Fragment>
            )}
        </div>
